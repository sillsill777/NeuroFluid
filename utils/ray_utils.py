...
def get_rays(directions, c2w):
    ...
    rays_d = rays_d / torch.norm(rays_d, dim=-1, keepdim=True)  # Original Nerf doesn't normalize rays_d
...
def sample_pdf(bins, weights, N_samples, det=False, pytest=False):  # det=True -> default
    # Get pdf
